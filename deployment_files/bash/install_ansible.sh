...
sudo -u amarriott  sshpass -p "password" ssh-copy-id -i /home/amarriott/.ssh/sshkey.pub amarriott@192.168.11.10
sudo -u amarriott  sshpass -p "password" ssh-copy-id -i /home/amarriott/.ssh/sshkey.pub amarriott@192.168.13.10
